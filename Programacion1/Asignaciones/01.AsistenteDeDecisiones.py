...
#1er paso:  Pedir el día de la semana
dia = limpiar_entrada("¿Qué día de la semana es hoy?: ")

#2do paso:  Pedir el clima actual del dia ingresado
...
match dia:
    ...
    case "sabado" | "domingo": # Agrupamos fin de semana ya que suelen ser dias libres para divertirse o relajarse.
        if clima == "soleado":
    ...
    case _: # Quize agregar casos por defecto para cualquier otro día (martes, miércoles, jueves) o alguna entrada invalida por parte del usuario.
        if clima == "soleado":
...
# --- Requisito 5: Imprimir la recomendación clara y amigable ---
